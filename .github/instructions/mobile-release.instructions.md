...
- When reopening with a saved token, the mobile app must refresh the authenticated user from `/api/profile`; cached role data must never control whether Admin features are displayed.
