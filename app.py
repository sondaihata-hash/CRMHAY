...
class Customer(db.Model):
    ...
    representative_name = db.Column(db.String(200), nullable=True)
    representative_position = db.Column(db.String(200), nullable=True)
...
def ensure_subscription_payment_columns():
    ...
    if 'public_token' not in order_payment_columns:
        db.session.execute(text(
